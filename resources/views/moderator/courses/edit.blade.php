...
@section('title', 'moderator: Edit course ')
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="input-group">
                                <select class='form-select' type="text" name="level" id="name">
                                    @foreach (['junior', 'middle', 'senior'] as $level)
                                        :
                                        <option @if ($level == $course->level) selected @endif
                        ...
                        <div class="col-auto">
                            ...
                            <div class="input-group">
                                <input type="number" value="{{ $course->day_duration }}" name="day_duration"
                                    class="form-control" id="day_duration">
                            </div>
                        </div>
