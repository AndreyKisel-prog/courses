...
<div class="d-flex justify-content-center my-5">
    <div style="width: 800px;height: 400px" id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-indicators">
            ...
            <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="3" aria-label="Slide 3" class="active" aria-current="true"></button>
        </div>
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <svg class="bd-placeholder-img" width="100%" height="400px" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"> -->
                ...
                <div class="container">
                    <div class="carousel-caption text-start">
                        ...
                        <p><a class="btn btn-lg btn-warning" href="{{route('users.index')}}">Go to 'users' table</a></p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-end">
                        ...
                        <p>----------------</p>
                        <p><a class="btn btn-lg btn-warning" href="{{route('orders.index')}}">Go to orders table</a></p>
                    </div>
                </div>
            </div>
